		...
		<div class="row">
				...
				<div class="owl-carousel owl-theme show-nav-title show-nav-title-both-sides news-carousel" data-plugin-options="{'items': 4, 'margin': 10, 'loop': true, 'nav': true, 'dots': false, 'autoplay': false}">
					<?php foreach ($news as $news_item): ?>
						<div class="home-carousel-card" onclick="location.href='<?=$news_item->buttonUrl?>';">
...
<br>
<div id="product-carousel" class="owl-carousel owl-theme full-width" data-plugin-options='{"items": 6, "loop": true, "nav": true, "dots": false, "autoplay": true, "autoplayTimeout": 5000, "autoplayHoverPause": true}'>
