						...
						<?php if ($hasText): ?>
							<div class="text-background">
								<?php if (!empty($s->name1)): ?>
									<h1 class="text-color-dark text-4 line-height-5 font-weight-semibold px-4 mb-2 appear-animation" data-appear-animation="fadeInDownShorterPlus" data-plugin-options="{'minWindowWidth': 0}">
								...
								<?php if (!empty($s->name2)): ?>
									<h1 class="text-color-dark font-weight-extra-bold text-5 mb-3 line-height-2 appear-animation" data-appear-animation="blurIn" data-appear-animation-delay="1000" data-plugin-options="{'minWindowWidth': 0}"><?php echo $s->name2; ?></h1>
								<?php endif; ?>
