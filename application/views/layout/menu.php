			...
			<div class="container-wide container py-2">
				<div class="row py-4">
					<div class="w-70 d-flex align-items-center">
						...
						<span class="d-flex align-items-center pe-8"><svg class="icon me-4"><use xlink:href="#mobile"></use></svg> Call: +32 9006868</span>
						<span class="d-flex align-items-center"><svg class="icon me-4"><use xlink:href="#envelope"></use></svg>hi@gracecosmetic.com</span>
					</div>
					...
					<ul class="navbar-nav">
						...
						<li class="nav-item transition-all-xl-1 py-xl-11 py-0 me-xxl-12 me-xl-10 dropdown dropdown-hover dropdown-fullwidth">
							<a class="nav-link d-flex justify-content-between position-relative py-xl-0 px-xl-0 text-uppercase fw-semibold ls-1 fs-15px fs-xl-14px dropdown-toggle"
							   href="./index.html" data-bs-toggle="dropdown" id="menu-item-home" aria-haspopup="true" aria-expanded="false">Home</a><div class="dropdown-menu mega-menu start-0 py-6 "
					...
					<div class="d-none d-xl-block w-60 ms-auto">
						<form action="#" method="get" class="search-box-1 form-border-transparent">
							<div class="position-relative">
								<input type="text" name="s" class="form-control bg-body-secondary ps-12" placeholder="What are you looking for?">
