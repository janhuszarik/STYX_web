...
<header id="header" class="header header-sticky header-sticky-smart disable-transition-all z-index-5">
	...
	<div class="topbar bg-body border-bottom">
		<div class="container-wide container d-flex justify-content-between align-items-center">
			<p class="mb-0 p-4 fs-6 fw-bold text-center flex-grow-1">STYX Naturcosmetic - nachhaltige Kosmetik aus Österreich</p>
		...
		<div class="main-header nav navbar bg-body navbar-light navbar-expand-xl py-6 py-xl-0">
			<div class="container-wide container flex-nowrap">
				...
				<ul class="d-none d-xl-flex navbar-nav">
					...
					<li class="nav-item transition-all-xl-1 py-xl-11 py-0 mx-xl-7 dropdown dropdown-hover dropdown-fullwidth position-static">
								...
								<div class="row">
									...
									<div class="col">
										...
										<ul class="list-unstyled mb-0">
											...
											<li>
												<a href="" class="border-hover text-decoration-none py-3 d-block"><span class="border-hover-target">Loasdasdgin</span></a>
											</li>
										</ul>
									</div>
					...
					<li class="nav-item transition-all-xl-1 py-xl-11 py-0 mx-xl-7 dropdown dropdown-hover dropdown-fullwidth">
						<a class="nav-link d-flex justify-content-between position-relative py-xl-0 px-xl-0 text-uppercase fw-semibold ls-1 fs-15px fs-xl-14px dropdown-toggle" href="#" data-bs-toggle="dropdown" id="menu-item-blocks" aria-haspopup="true" aria-expanded="false">Blocks</a>
				...
				<div class="icons-actions d-flex justify-content-end w-xl-50 fs-28px text-body-emphasis">
					...
					<div class="px-5 d-none d-xl-inline-block">
						<a class="lh-1 color-inherit text-decoration-none" href="<?=BASE_URL?>" data-bs-toggle="modal" data-bs-target="#signInModal">
