			...
			<div class="blog-posts single-post">
				...
				<article class="post post-large blog-single-post border-0 m-0 p-0">
					...
					<div class="post-content ms-0">
						...
						<h2 style="color: #aad998" class="font-weight-semi-bold"><?=lang('SCHOKOLADE_HEADING')?></h2>

						<div class="post-meta">
							<h4 class="text-color-black"><?=lang('SCHOKOLADE_SUBHEADING')?></h4>

							<span><i class="far fa-comments"></i>
								<a href="#">12 Comments</a></span>
						</div>
						<img src="<?=BASE_URL?>img/image/SCHOKOLADE.jpg" class="img-fluid float-start me-4 mt-2" alt="" />
						<h4><?=lang('SCHOKOLADE_SUBHEADING_TEXT')?></h4>
						<p><?=lang('SCHOKOLADE_LONGTEXT')?></p>

						<div class="post-block mt-5 post-share">
							<a href="https://shop.styx.at/Schokolade:::23.html" class="btn btn-primary w-50 mb-2"><?=lang('ZUR_HOMA_PAGE')?></a>
						...
						<div class="post-block mt-5 post-leave-comment">
							...
							<br>
							<form class="contact-form p-4 rounded bg-color-grey" action="<?=BASE_URL?>app/schokoladen" method="POST">
								<div class="p-2">
									<div class="row">
									...
									<div class="row">
										<div class="form-group col mb-0">
											<input type="hidden" name="section_id" value="Schokolade">
