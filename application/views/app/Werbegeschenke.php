			...
			<div class="blog-posts single-post">
				...
				<article class="post post-large blog-single-post border-0 m-0 p-0">
					...
					<div class="post-content ms-0">
						...
						<h2 style="color: #aad998" class="font-weight-semi-bold"><?=lang('WERBEGESCHENKE_HEADING')?></h2>

						<div class="post-meta">
							<h4 class="text-color-black"><?=lang('WERBEGESCHENKE_SUBHEADING')?></h4>
						</div>
						<img src="<?=BASE_URL?>img/image/werbegeschenke.jpg" class="img-fluid float-start me-4 mt-2" alt="" />
						<h4><?=lang('WERBEGESCHENKE_SUBHEADING_TEXT')?></h4>
						<p><?=lang('WERBEGESCHENKE_LONGTEXT')?></p>
						<p><?=lang('WERBEGESCHENKE_SUBHEADING_TEXT_HEADING')?></p>

						<div class="post-block mt-5 post-share">
							<a href="<?=BASE_URL?>img/pdf/STYX_Folder_Lohnproduktion_Geschenke_140x140mm_2024.pdf" class="btn btn-primary w-50 mb-2"><?=lang('ZUR_PDF_BUTTON')?></a>
						...
						<br>
						<p><?=lang('WERBEGESCHENKE_TEXT_FOOTER')?></p>
						...
						<div class="post-block mt-5 post-leave-comment">
							...
							<br>
							<form class="contact-form p-4 rounded bg-color-grey" action="<?=BASE_URL?>app/werbegeschenke" method="POST">
								<div class="p-2">
									<div class="row">
									...
									<div class="row">
										<div class="form-group col mb-0">
											<input type="hidden" name="section_id" value="Werbegeschenke">
