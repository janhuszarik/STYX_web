...
$route['admin/article_categories/add'] = 'admin/articleCategoriesSave';
$route['admin/article_categories/edit/(:num)'] = 'admin/articleCategoriesSave';
$route['admin/article_categories/del/(:num)'] = 'admin/articleCategoriesSave';
