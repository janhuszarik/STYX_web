...
// administrator
	...
	$route['admin/article_categories'] 		= 'admin/articlesSave';
	$route['admin/article_categories/edit/(:num)'] = 'admin/article_categories/edit/$1';
	$route['admin/article_categories/delete/(:num)'] = 'admin/article_categories/delete/$1';
